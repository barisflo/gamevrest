    ...
    <div class="w-full max-w-5xl mx-auto flex flex-col justify-center">
        <div class="max-w-[185rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                 <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white mb-6">Contact us </h2>
<!--
                <a class="inline-block text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" target="_blank"
                    href="https://www.instagram.com/barisflo/">
                    <svg class="m-auto" xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="currentColor"
                        viewBox="-8 -8 64 64">
                        <path
                ...
                <a class="group flex flex-col mb-2 bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800"
                    href="https://www.instagram.com/barisflo/" target="_blank">
                    <div class="p-4 md:p-5">
                        <div class="flex">
                            <svg class="m-auto" xmlns="http://www.w3.org/2000/svg"  width="32" height="32" fill="currentColor"
                        viewBox="0 0 48 48">
                        <path
                            d="M 16.5 5 C 10.16639 5 5 10.16639 5 16.5 L 5 31.5 C 5 37.832757 10.166209 43 16.5 43 L 31.5 43 C 37.832938 43 43 37.832938 43 31.5 L 43 16.5 C 43 10.166209 37.832757 5 31.5 5 L 16.5 5 z M 16.5 8 L 31.5 8 C 36.211243 8 40 11.787791 40 16.5 L 40 31.5 C 40 36.211062 36.211062 40 31.5 40 L 16.5 40 C 11.787791 40 8 36.211243 8 31.5 L 8 16.5 C 8 11.78761 11.78761 8 16.5 8 z M 34 12 C 32.895 12 32 12.895 32 14 C 32 15.105 32.895 16 34 16 C 35.105 16 36 15.105 36 14 C 36 12.895 35.105 12 34 12 z M 24 14 C 18.495178 14 14 18.495178 14 24 C 14 29.504822 18.495178 34 24 34 C 29.504822 34 34 29.504822 34 24 C 34 18.495178 29.504822 14 24 14 z M 24 17 C 27.883178 17 31 20.116822 31 24 C 31 27.883178 27.883178 31 24 31 C 20.116822 31 17 27.883178 17 24 C 17 20.116822 20.116822 17 24 17 z">
                        </path>
                            ...
                            <div class="grow ml-5">
                                <h3
                                    class="group-hover:text-celadonBlue font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                                    Instagram
                                </h3>
                ...
                <a class="group flex flex-col  mb-2 bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800"
                    href="https://linkedin.com/in/florent-baris" target="_blank">
                    <div class="p-4 md:p-5">
                        <div class="flex">
                ...
                <a
                    ...
                    <Mailto mail="gamevrest@gmail.com">
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                <svg class="mt-1 pl-1 shrink-0 text-gray-800 dark:text-gray-200"
                                ...
                                <div class="grow ml-5">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        at <span
                                            class="text-celadonBlue font-medium dark:text-blue-500">***@gmail.com</span>
                                    </p>
                                </div>
                            </div>
                        </div>

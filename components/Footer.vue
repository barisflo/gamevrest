<template>
    <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="grid grid-cols-2 gap-6 mb-10 md:grid-cols-3 lg:grid-cols-4">
            <div class="hidden col-span-full lg:col-span-1 lg:block">
                <a class="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">
                    <NuxtImg  src="/logo.png" width="50"/>
                </a>
                <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-gray-400">©2024 Gamevrest</p>
            </div>
            <div class="block col-span-full col-span-1 lg:hidden">
                <a class="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">
                    <NuxtImg  src="/logo.png" width="50"/>
                </a>
                <p class="mt-3 text-xs text-gray-600 sm:text-sm dark:text-gray-400">©2024 Gamevrest</p>
            ...
            <div>
                ...
                <div class="grid mt-3 space-y-3 text-sm">
                    <p><a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                            href="/soon">Previous Games</a></p>
                    <p><a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
            ...
            <div class="sm:flex sm:justify-between sm:items-center">
                <div class="flex items-center gap-x-3">
                    <div class="hs-dropdown relative inline-flex [--placement:top-left]">
                        ...
                        <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700"
                            ...
                            <a class="flex items-center px-3 py-2 text-sm text-gray-800 rounded-md gap-x-2 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                href="/soon">
                    ...
                    <div class="ml-4 space-x-4 text-sm">
                        <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                            href="/soon">Terms</a>
                        <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                            href="/soon">Privacy</a>
                        <a class="inline-flex text-gray-600 gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                ...
                <div class="flex items-center justify-between">
                    <div class="mt-3 sm:hidden">
                        <a class="flex-none text-xl font-semibold dark:text-white" href="/soon" aria-label="Brand">Brand</a>
                        <p class="mt-1 text-xs text-gray-600 sm:text-sm dark:text-gray-400">© 2024 Gamevrest</p>
                    </div>

                    <div class="space-x-4">
                        <a class="inline-block text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" href="/soon">
